                    ...
                    <div class="card product-sales-main">
                        <div class="card-header border-bottom">
                            ...
                            <div class="card-options ms-auto">
                                <a href="{{ route('admin.upload-tips.create') }}" class="btn btn-primary btn-sm">Add</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="">
...
<script>
    $(document).ready(function() {
        ...
        if (!$.fn.DataTable.isDataTable('#datatable')) {
            let dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.upload-tips.index') }}",
                    type: "GET",
                },
    ...
    function statusChange(id) {
        NProgress.start();
        let url = "{{ route('admin.upload-tips.status', ':id') }}";
        $.ajax({
            type: "GET",
    ...
    function deleteItem(id) {
        NProgress.start();
        let url = "{{ route('admin.upload-tips.destroy', ':id') }}";
    ...
    function goToEdit(id) {
        let url = "{{ route('admin.upload-tips.edit', ':id') }}";
